...
unsigned char dpx_get_unsigned_byte (FILE *);
void skip_bytes (unsigned int, FILE *);
signed char get_signed_byte (FILE *);
unsigned short dpx_get_unsigned_pair (FILE *);
unsigned short sdpx_get_unsigned_pair (unsigned char *);
...
unsigned char tt_dpx_get_unsigned_byte (rust_input_handle_t handle);
signed char tt_get_signed_byte (rust_input_handle_t handle);
unsigned short tt_dpx_get_unsigned_pair (rust_input_handle_t handle);
