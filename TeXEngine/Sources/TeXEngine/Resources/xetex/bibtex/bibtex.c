...
static void print_confusion(void) {
  ...
  puts_log("*Please contact the developer of TeXNote*\n");
  mark_fatal();
}
...
int bibtex_main(const char *aux_file_name) {
  ...
  if (verbose)
    puts_log("This is BibTeX, Version 0.99d (ported to iOS/iPadOS platform)\n");
  else
    ttstub_puts(log_file, "This is BibTeX, Version 0.99d (ported to iOS/iPadOS platform)\n");
